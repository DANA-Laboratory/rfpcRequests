...
در سازمانها افراد و ادارات مختلف متولی انجام امور محول به خود میباشند، به عنوان مثال اداره نقلیه به با انجام سرویسهای حمل و نقل به در خواستهای نقلیه پاسخ میدهد، بخش تداکات با انجام امور خرید به درخواسهای خرید پاسخ میدهد، بخش تعمیرات با انجام امور تعمیراتی پاسخگوی درخواسهای تعمیرات است و ....

آنچه در همه موارد فوق مشترک میباشد *درخواست * است. درخواستهای انجام کار در سازمانها میتوانند به طرق مختلف اعلام گردند، در سادترین شکل ممکن این درخواستها شفاهی میباشند، طراحی فرمهای مکتوب درخواست و تعریف آنها در مراحل مختلف استاندارد سازی و تعریف فرآیندها یکی از الزامات مهم به شمار میآید. همچنین درخواسها میتوانند بصورت الکترونیک از طریق سیستم مکاتبات اداری یا نرم افزارهای ارسال و دریافت پیام الکترونیکی انجام پذیرند.

یکی از روشهای برتر در مدیریت درخواسهای انجام کار، طراحی و پیاده سازی سامانه ویژه مدیریت این درخواسها میباشد.
چنین سامانه ای باید امکان تعریف انواع درخواستها، مدیریت کارتابل ، مدیریت بانک اطلاعاتی، مدیریت گردش کار و مدیریت کاربران و بالاخره تولید گزارشات را شامل گردد.
امکان نصب بر فضای اینترنت و ایجاد محیطی امن برای انجام کارها نیز از ویژگی های لازم چنین سامانه ای میباشد.
