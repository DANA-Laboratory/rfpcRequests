...
چنین سامانه ای باید 
<ul>
<li>امکان تعریف انواع درخواستها</li>
<li>مدیریت کارتابل</li>
<li>مدیریت بانک اطلاعاتی</li>
<li>مدیریت گردش کار</li> 
<li>مدیریت کاربران</li> 
<li>و بالاخره تولید گزارشات </li>
</ul>
<br/>
را انجام دهد.
<br/>
...
یک سیستم جهت مدیریت درخواستهای انجام کار، کاربر امکان ثبت درخواست و پیگیری آنرا از طریق کارتابل خود دارد.</p>
